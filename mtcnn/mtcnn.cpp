...
mtcnn::mtcnn(){
#ifdef pbModelSwitch
    Pnet.load_param("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det1.param");
    Pnet.load_model("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det1.bin");
    Rnet.load_param("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det2.param");
    Rnet.load_model("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det2.bin");
    Onet.load_param("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det3.param");
    Onet.load_model("/home/liuhui/CLionProjects/mtcnn-ok/build/mtcnn/det3.bin");
#else
    Pnet.load_param("/home/liuhui/xnetfacesrc/build/pnet.param");
    Pnet.load_model("/home/liuhui/xnetfacesrc/build/pnet.bin");
    Rnet.load_param("/home/liuhui/xnetfacesrc/build/rnet.param");
    Rnet.load_model("/home/liuhui/xnetfacesrc/build/rnet.bin");
    Onet.load_param("/home/liuhui/xnetfacesrc/build/onet.param");
    Onet.load_model("/home/liuhui/xnetfacesrc/build/onet.bin");
...
#else
            ex.input("rnet/input", in);
            ncnn::Mat score, bbox;
            ex.extract("rnet/prob1", score);
            ex.extract("rnet/conv5-2/conv5-2", bbox);
#endif
...
#else
            ex.input("onet/input", in);
            ncnn::Mat score, bbox, keyPoint;
            ex.extract("onet/prob1", score);
            ex.extract("onet/conv6-2/conv6-2", bbox);
            ex.extract("onet/conv6-3/conv6-3", keyPoint);
#endif
//            cv::Mat cvBbox(score.h,score.w,CV_32FC2);
//            score.to_pixels(cvBbox.data,ncnn::Mat::PIXEL_RGBA);
//
////            mtcnn::ncnnMat2cvMat(score,cvBbox.data,2);
//            cout<<cvBbox<<endl<<"-----------------"<<endl;
//            ncnn::Mat newBbox = ncnn::Mat::from_pixels(cvBbox.data,ncnn::Mat::PIXEL_RGB,cvBbox.cols,cvBbox.rows);
